  ...
  return (
    <div className="h-full">
      ...
      <div className="px-5">
        ...
        <Carousel>
          <CarouselContent className="ml-4 mt-4">
            {podborki.length === 0 && "сейчас твоя мама придумает тебе подборки..."}
      ...
      <div className="px-5 mt-10">
        Мамы ваших друзей
        <span className="block text-slate-500">Почитайте мнение о вас от других мам</span>
        <div className="w-full h-20 bg-pink-500 rounded-md relative">
          ...
          />
          <section className="size-10 top-4 left-16 absolute text-white w-20">Мама Оля</section>
        </div>
      </div>
    </div>
  );
